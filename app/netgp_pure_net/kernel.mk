...
ifeq ($(TYPE), gas)
	...
	CFG_FILE = ./app/netgp_pure_net/kernel_gas.cfg
	DEFAULT_CFG = ./app/netgp_pure_net/kernel_gas.cfg
else
	CFG_FILE = ./app/netgp_pure_net/kernel_gs.cfg
	DEFAULT_CFG = ./app/netgp_pure_net/kernel_gs.cfg
endif
