## this file want to overlap GS and Apply stage
TARGET = hw
...
include host/netgp_overlap/Makefile
...
include test/test_overlap/Makefile
include src/pr/Makefile

## only GAS node need sync and apply kernel.
ifeq ($(TYPE), gas)
	include src/apply/Makefile
	CFG_FILE = ./app/netgp_overlap/kernel_gas.cfg
	DEFAULT_CFG = ./app/netgp_overlap/kernel_gas.cfg
else
	CFG_FILE = ./app/netgp_overlap/kernel_gs.cfg
	DEFAULT_CFG = ./app/netgp_overlap/kernel_gs.cfg
endif
